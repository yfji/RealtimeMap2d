...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btn_preview->setGeometry(QRect(20, 30, 71, 41));
        ...
        btn_record = new QPushButton(groupBox_3);
        btn_record->setObjectName(QStringLiteral("btn_record"));
        btn_record->setGeometry(QRect(180, 30, 131, 41));
        btn_detect = new QPushButton(groupBox_3);
        btn_detect->setObjectName(QStringLiteral("btn_detect"));
        btn_detect->setGeometry(QRect(100, 30, 61, 41));
        btn_record->raise();
        btn_start->raise();
        btn_pause->raise();
        btn_resume->raise();
...
"IP Camera", nullptr));
        ...
        btn_preview->setText(QApplication::translate("MainWindow", "Preview", nullptr));
        ...
        btn_record->setText(QApplication::translate("MainWindow", "Start Record", nullptr));
        btn_detect->setText(QApplication::translate("MainWindow", "Detect", nullptr));

...
#include "../MapWithMission/gpsclient.h"
...
QT_MOC_LITERAL(1, 10, 17), // "publishGPSMessage"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 11), // "std::string"
QT_MOC_LITERAL(4, 41, 3) // "msg"

    },
    "Publisher\0publishGPSMessage\0\0std::string\0"
    "msg"
};
...
void Publisher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->publishGPSMessage((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Publisher::*_t)(std::string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Publisher::publishGPSMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Publisher::publishGPSMessage(std::string _t1)
{
